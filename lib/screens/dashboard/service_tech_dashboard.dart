...
class ServiceTechDashboard extends StatefulWidget {
  final User user;
  ...
  @override
  State<ServiceTechDashboard> createState() => _ServiceTechDashboardState();
}

class _ServiceTechDashboardState extends State<ServiceTechDashboard> {
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Checklist feature coming soon!')),
                      );
                    },
